...
const costsData = {
  title: "Typische Kostenbereiche",
  subtitle: "Orientierungswerte für Sanierungsprojekte",
...
export default function LeistungenHub() {
  ...
  <a href="https://wa.me/496074960620" className="btn br-btn-whatsapp">
    WhatsApp
  </a>

  <a href="tel:+496074960620" className="btn br-btn-outline">
    <Phone size={18}/>
    Jetzt anrufen
  </a>
  ...
  <a href="#kontakt" className="btn br-btn-orange">
    Projekt anfragen
        ...
        <div className="br-hero-right" style={{ backgroundImage: 'url(img/leistungen-hero.jpg' }}>
        </div>
      </section>
      ...
      <section className="br-section br-bg-light">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="br-section-title">Wobei können wir helfen?</h2>
          ...
          <div className="br-projects-grid" style={{gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))'}}>
            ...
            <Link to="/komplettsanierung-rhein-main" className="br-project-card" style={{textDecoration: 'none', color: 'inherit', border: '1px solid #e5e7eb'}}>
              <div className="br-project-img" style={{ backgroundImage: 'url(/img/Complete-renovation.jpg)', height: '200px' }}></div>
...
<CostsSection costsData={costsData} />
  ...
  seoContent={
    <>
      <p>
        Radex bietet Sanierungsleistungen im gesamten
        Rhein-Main-Gebiet an.
      </p>

      <p>
        Von Komplettsanierungen bis zu einzelnen Gewerken.
      </p>
    </>
  }
  links={seoLinks}
