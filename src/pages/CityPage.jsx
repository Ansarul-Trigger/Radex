...
const costsData = {
    title: `Kosten für Sanierung in ${city.name}`,
    items: [
      {
        title: "Badsanierung",
        price: "ab 8.000 €",
  ...
  const faqsData = [
    {
    q: `Arbeitet Radex auch in meinem Stadtteil?`,
    a: `Ja. Radex betreut Projekte in allen Stadtteilen von ${city.name}.`
  },
  {
    q: `Bietet Radex Komplettsanierungen an?`,
    a: `Ja. Als Generalunternehmer übernehmen wir Planung, Koordination und Umsetzung aus einer Hand.`
  },
  {
  ...
  {
    q: `Wie schnell ist ein Vor-Ort-Termin möglich?`,
    a: `Je nach Projektumfang vereinbaren wir zeitnah einen Termin.`
  },
  {
    q: `Welche Leistungen bietet Radex in ${city.name} an?`,
    a: `Badsanierung, Wohnungssanierung, Haussanierung, Altbausanierung, Innenausbau, Heizung & Sanitär usw.`
  }
  ];
        ...
        <div className="br-hero-left">
          <div className="br-hero-content">
            ...
            <p className="br-hero-subtitle">
               Badsanierung, Wohnungssanierung, Haussanierung und Modernisierung in {city.name}
  – mit einem Ansprechpartner für Planung, Koordination und Umsetzung.
            </p>
           
            <p>Sie suchen einen erfahrenen Ansprechpartner für Sanierung, Badsanierung oder Modernisierung in {city.name}? Radex begleitet Privatkunden, Eigentümer, Vermieter, Hausverwaltungen und Unternehmen bei Projekten jeder Größe.
Als SHK-Meisterbetrieb und Generalunternehmer übernehmen wir Planung, Koordination und Umsetzung aus einer Hand. Von der ersten Beratung bis zur schlüsselfertigen Übergabe erhalten Sie einen festen Ansprechpartner für Ihr Projekt.
Ob Badsanierung, Wohnungssanierung, Haussanierung, Altbausanierung oder Modernisierung – Radex betreut Projekte in allen Stadtteilen von {city.name}sowie im gesamten Rhein-Main-Gebiet.
</p><br/>
