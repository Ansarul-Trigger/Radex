...
export default function EinsatzgebieteHub() {
  ...
  const cities = [
    { name: "Frankfurt am Main", img: "img/Frankfurt.png", link: "/sanierung-frankfurt-am-main" },
    { name: "Darmstadt", img: "img/Darmstadt.png", link: "/haus-wohnung-bad-modernisieren-darmstadt" },
    { name: "Offenbach", img: "img/Offenbach.jpg", link: "/sanierung-offenbach-am-main" },
    { name: "Hanau", img: "img/Hanau.jpg", link: "/sanierung-hanau" },
    { name: "Wiesbaden", img: "img/Wiesbaden.jpg", link: "/sanierung-wiesbaden" },
    { name: "Mainz", img: "img/Mainz.jpg", link: "/sanierung-mainz" },
    { name: "Aschaffenburg", img: "img/Aschaffenburg.jpg", link: "/sanierung-aschaffenburg" },
    { name: "Rödermark & Rodgau", img: "img/Rödermark.jpg", link: "/sanierung-roedermark" }
  ];
