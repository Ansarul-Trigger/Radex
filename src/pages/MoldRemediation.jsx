...
export default function MoldRemediation() {
  ...
  const typicalProjectsData = {
    ...
    projects: [
      ...
      { title: 'Schimmel im Keller', desc: 'Feuchte Kellerwände, Kondensation, aufsteigende Feuchtigkeit oder fehlende Abdichtung.', img: 'img/SchimmelKeller.jpg' },
      ...
      { title: 'Altbausanierung', desc: 'Bei älteren Gebäuden können mehrere Themen zusammen auftreten und müssen gemeinsam bewertet werden.', img: '/img/Altbausanierung-jj.jpg' }
    ]
  };
